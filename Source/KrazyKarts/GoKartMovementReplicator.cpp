...
void UGoKartMovementReplicator::AutonomousProxy_OnRep_ServerState() 
{
	...
	for(const FGoKartMove& Move : UnacknowledgeMoves) //Replay the move
	{
...
{
	return ClientTimeBetweenLastUpdates * 100; // Velocity (m/s) convert to Location (cm)
}
...
{	
	...
	return true; //Prevent from cheating
}